    ...
    <section class="section">
      <div class="card">
        ...
        <div class="card-header d-flex justify-content-between">
          ...
          <div>
            <button type="button" id="addModalMaterial" class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#inlineForm">
              Nuevo
            </button>
          </div>
        </div>
                ...
                <table class="table" id="table1">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center">{{$value->toe <= 0 ?"--":$value->toe}}</td>
                      <td class="text-center">{{$value->dotado <= 0 ?"--":$value->dotado}}</td>
                      <td class="text-center">{{$value->faltan <= 0 ?"--":$value->faltan}}</td>
                        ...
                        <div class="btn-group mb-1">
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              <a class="dropdown-item" href="#" onclick="editMaterial({{$value->id}})">Editar</a>
                              <a class="dropdown-item" href="#" onclick="deletMaterial({{$value->id}})" >Eliminar</a>
                            </div>
                          </div>
                        </div>
                      </td>
          ...
          <div class="row">
            <div class="col-md-12 col-12 mb-3 ocult_elemet">
              <div class="form-group mb-0 ">
                ...
                <select name="materiale_id" id="materiale_id" class=" form-select form-select-md list_select_material">
                </select>
              </div>
            ...
            <div class="col-md-12 col-12 mb-3 ocult_elemet">
              <div class="form-group mb-0">
                ...
                <select name="sub_brigada_id" id="sub_brigada_id" class=" form-select form-select-md list_select_area">
                </select>
            ...
            <div class="col-md-6 col-12">
              <div class="form-group mb-3">
                ...
                <input type="number" value="0" id="toe" class="form-control form-control-md inputValue" placeholder="Ingrese el toe" name="toe">
            ...
            <div class="col-md-6 col-12">
              <div class="form-group mb-3">
                ...
                <input type="number" value="0" id="dotado" class="form-control form-control-md inputValue" placeholder="Ingrese el dotado" name="dotado">
            ...
            <div class="col-md-6 col-12">
              <div class="form-group mb-3">
                ...
                <input type="number" value="0" readonly id="faltan" class="form-control form-control-md " placeholder="Ingrese el faltan" name="faltan">
            ...
            <div class="col-md-6 col-12">
              <div class="form-group mb-3">
                ...
                <input type="number" value="0" readonly id="operativo" class="form-control form-control-md " placeholder="Ingrese el operativo" name="operativo">
            ...
            <div class="col-md-12 col-12">
              <div class="form-group mb-3">
                ...
                <input type="number" value="0" id="inoperativo" class="form-control form-control-md inputValue" placeholder="Ingrese el inoperativo" name="inoperativo">
