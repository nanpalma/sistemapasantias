    ...
    <div class="page-title">
      <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last">
          <h3>Vehículo</h3>
          <p class="text-subtitle text-muted">Aqui se encuentra todos los vehículo disponibles.</p>
        </div>
        <div class="col-12 col-md-6 order-md-2 order-first">
          <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Lista De Vehículo</li>
            </ol>
          </nav>
        </div>
      </div>
...
<div class="modal fade text-left" id="inlineForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true" >
  <div class="modal-dialog  modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
    <div class="modal-content">
      ...
      <form action="{{route('transporte.vehiculos.store')}}" method="POST" id="formAddMaterial">
        @csrf
          ...
          <div class="row">
            <div class="col-md-12 col-12">
              <div class="form-group">
                ...
                <input type="text" id="placa" class="form-control form-control-lg " placeholder="Ingrese la placa" name="placa">
            ...
            <div class="col-md-12 col-12">
              <div class="form-group">
                ...
                <input type="text" id="nombre" class="form-control form-control-lg " placeholder="Ingrese el nombre" name="nombre">
            ...
            <div class="col-md-12 col-12">
              <div class="form-group">
                ...
                <input type="text" id="modelo" class="form-control form-control-lg " placeholder="Ingrese el nombre" name="modelo">
...
<script src="{{ asset('assets_use/static/js/components/dark.js') }}"></script>
  ...
  <script src="{{ asset('transporte/vehiculos.js') }}"></script>
