...
@section('title', 'Transporte - Lista De Vehículos')
                        ...
                        <div class="row">
                            <div class="col-md-12 col-12">
                                <div class="form-group">
                                    <label for="nombre">VEHÍCULO DE TRASPORTE
                            ...
                            <div class="col-md-12 col-12">
                                <div class="form-group">
                                    <label for="placa">SERIAL O PLACA </label>
                            ...
                            <div class="col-md-12 col-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-select form-select-LG" name="modelo" id="modelo">
                                        <option value="VEHÍCULO DE TRASPORTE">VEHÍCULO DE TRASPORTE</option>
                                        <option value="SISTEMA BLINDADOS">SISTEMA BLINDADOS</option>
                                        <option value="SISTEMAS DE ARTILLERÍA">SISTEMAS DE ARTILLERÍA</option>
                                    </select>
