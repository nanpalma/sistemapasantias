                  ...
                  <tbody>
                      ...
                      <td class="col-3">
                        <div class="d-flex align-items-center">
                          <div class="avatar avatar-md">
                            <img src="{{asset('assets_use/compiled/jpg/5.jpg')}}">
                          </div>
                    ...
                    <tr>
                      <td class="col-3">
                        <div class="d-flex align-items-center">
                          <div class="avatar avatar-md">
                            <img src="{{asset('assets_use/compiled/jpg/2.jpg')}}">
                          </div>
    ...
    <div class="col-12 col-lg-3">
        ...
        <div class="card-body py-4 px-4">
          <div class="d-flex align-items-center">
            <div class="avatar avatar-xl">
              <img src="{{asset('assets_use/compiled/jpg/1.jpg')}}" alt="Face 1">
            </div>
            <div class="ms-3 name">
      ...
      <div class="card">
        ...
        <div class="card-content pb-4">
          ...
          <div class="recent-message d-flex px-4 py-3">
            <div class="avatar avatar-lg">
              <img src="{{asset('assets_use/compiled/jpg/1.jpg')}}">
            </div>
            <div class="name ms-4">
