        ...
        <div class="col-12 col-md-6 order-md-2 order-first">
          <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Lista De Materiales</li>
            </ol>
          </nav>
        </div>
      </div>
...
<div class="modal fade text-left" id="inlineForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true" >
  <div class="modal-dialog  modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
    <div class="modal-content">
      ...
      <form action="{{route('armamento.material.store')}}" method="POST" id="formAddMaterial">
        @csrf
          ...
          <div class="row">
            ...
            <div class="col-md-12 col-12">
              <div class="form-group">
                ...
                <select name="tipo_material_id" id="tipo_material_id" class="choices form-select form-select-lg">
