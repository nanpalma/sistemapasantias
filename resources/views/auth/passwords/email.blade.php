...
<head>
    ...
    <title>Olvidé mi contraseña - Panel de administración de Mazer</title>
        ...
        <div id="auth-left">
          ...
          @endif
            ...
            <form method="POST" action="{{ route('password.email') }}">
              @csrf
                <div class="form-group position-relative has-icon-left mb-4">
                    <input id="email" placeholder="Ingrese el correo" type="email" class="form-control form-control-xl @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
            ...
            <div class="text-center mt-5 text-lg fs-4">
                <p class='text-gray-600'>¿Recuerdas tu cuenta? <a href="{{ route('login') }}" class="font-bold">Ir a login</a>.
                </p>
            </div>
        </div>
    </div>
