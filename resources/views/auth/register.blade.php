                ...
                <div id="auth-left">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input id="name" placeholder="Ingrese el nombre" type="text"
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input id="email" type="email" placeholder="Ingrese el correo"
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input id="password-confirm" type="password" placeholder="Confirmar contraseña"
                                class="form-control form-control-xl" name="password_confirmation" required
                    ...
                    <div class="text-center mt-5 text-lg fs-4">
                        <p class='text-gray-600'>¿Ya tienes una cuenta? <a href="{{ route('login') }}"
                                class="font-bold">Ir a login</a>.</p>
                    </div>
                </div>
            </div>
