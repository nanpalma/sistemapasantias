        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    <p class="auth-subtitle mb-5">Ingrese su correo electrónico y le enviaremos un enlace para
                    ...
                    <div class="text-center mt-5 text-lg fs-4">
                        <p class='text-gray-600'>¿Recuerdas tu cuenta? <a href="{{ route('login') }}"
                                class="font-bold">Ir a login</a>.
                        </p>
                    </div>
                </div>
            </div>
