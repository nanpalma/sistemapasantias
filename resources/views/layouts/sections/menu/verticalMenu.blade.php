  ...
  <div class="sidebar-wrapper active">
    <div class="sidebar-header position-relative">
      <div class="d-flex justify-content-between align-items-center mb-3 pb-2 border-bottom">
        <div class="logo">
          <a href="index.html"><img src="{{asset('assets_use/compiled/svg/logo.svg')}}" alt="Logo" srcset=""></a>
        </div>
      ...
      <div class="header-top-right border-bottom pb-3">
        ...
        <div class="dropdown">
            <a href="#" id="topbarUserDropdown" class="user-dropdown d-flex align-items-center dropend dropdown-toggle justify-content-between" data-bs-toggle="dropdown" aria-expanded="false">
